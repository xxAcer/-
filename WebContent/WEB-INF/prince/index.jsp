...
<link href="lib/fancybox/source/jquery.fancybox.css-v=2.1.5.css"
...
<link href="lib/font-awesome/css/font-awesome.min.css-v=4.6.2.css"
 ...
 ">
		...
		<div class="header-inner">
			<div class="site-brand-wrapper">
				<div class="site-meta ">
					...
					<div class="custom-logo-site-title">
						<a href="index" class="brand" rel="start"> <span
							class="logo-line-before"><i></i></span> <span class="site-title">Prince
								| 周润泽的博客</span> <span class="logo-line-after"><i></i></span>
						</a>
					</div>

					<h1 class="site-subtitle" itemprop="description">XXPrince</h1>
			...
			<ul id="menu" class="menu">
				...
				<li class="menu-item menu-item-home"><a href="index"
					rel="section"> <i class="menu-item-icon fa fa-fw fa-home"></i>
						<br /> 首页
				</a></li>

				<li class="menu-item menu-item-archives"><a href="archives"
					rel="section"> <i class="menu-item-icon fa fa-fw fa-archive"></i>
						<br /> 所有日志
				</a></li>

				<li class="menu-item menu-item-about"><a href="about"
					rel="section"> <i class="menu-item-icon fa fa-fw fa-user"></i>
						<br /> 关于
				</a></li>

				<li class="menu-item menu-item-tags"><a href="tags"
					rel="section"> <i class="menu-item-icon fa fa-fw fa-tags"></i>
						<br /> 标签
				</a></li>

				<li class="menu-item menu-item-message"><a href="message"
					rel="section"> <i class="menu-item-icon fa fa-fw fa-commenting"></i>
						<br /> 留言
				</a></li>
					...
					<div class="local-search-header clearfix">
						...
						<div class="local-search-input-wrapper">
							<input autocapitalize="off" autocomplete="off" autocorrect="off"
								placeholder="搜索..." spellcheck="false" type="text"
		...
		<div class="main-inner">
			<div class="content-wrap">
				<div id="content" class="content">
					<c:forEach items="${blogs }" var="blogs">
						<section id="posts" class="posts-expand"> <article
							class="post post-type-normal " itemscope
							itemtype="http://schema.org/Article">
						<link itemprop="mainEntityOfPage"
							href="http://Prince.xyz/2017/03/14/Github-upload-localProject/">
						...
						<h2 class="post-title" itemprop="name headline">
							<a class="post-title-link" href="2017/index?bno=${blogs.bno }"
								itemprop="url"> ${blogs.bname } </a>
						</h2>
						...
						<div class="post-meta">
							<span class="post-time"> <span class="post-meta-item-icon">
									...
									itemprop="dateCreated datePublished"> ${blogs.bdate } </time>

							</span> <span id="/2017/03/14/Github-upload-localProject/"
								class="leancloud_visitors" data-flag-title="${blogs.bname }">
								<span class="post-meta-divider">|</span> <span
								class="post-meta-item-icon"> <i class="fa fa-eye"></i>
							</span> <span class="post-meta-item-text">阅读次数 </span> <span
								class="leancloud-visitors-count">${blogs.reads }</span>
							</span>
						...
						<div class="post-body" itemprop="articleBody"
							style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis; height: 500px;">

							${blogs.content }

						</div>
							<div class="post-button text-center">
								<a class="btn" href="2017/index?bno=${blogs.bno }"
					...
					<nav class="pagination"> <span class="page-number current">1</span>
					<a class="page-number" href="/page/2/">2</a> <a class="extend next"
						rel="next" href="/page/2/"><i class="fa fa-angle-right"></i></a> </nav>
				</div>
			</div>
			...
			<div class="sidebar-inner">
				...
				<div class="site-author motion-element" itemprop="author" itemscope
					itemtype="http://schema.org/Person">
					<img class="site-author-image" itemprop="image" src="img/zgr.png"
				...
				<div class="site-state-item site-state-posts">
					<a href="archives/index.htm" tppabs="http://Prince.xyz/archives">
						<span class="site-state-item-count">${counts }</span> <span
				...
				<div class="links-of-author motion-element">
					...
					<span class="links-of-author-item"> <a href=" "
						target="_blank" title="GitHub"> <i class="fa fa-fw fa-github"></i>
		...
		<div class="footer-inner">
			...
			<div class="theme-info">
				主题 - <a class="theme-link"> XXPrince </a>
			</div>
	...
	<script type="text/javascript" src="lib/jquery/index.js-v=2.1.3"
	...
	<script type="text/javascript" src="js/src/utils.js-v=5.1.0"
		tppabs="http://Prince.xyz/js/src/utils.js?v=5.1.0"></script>

	<script type="text/javascript" src="js/src/motion.js-v=5.1.0"
		tppabs="http://Prince.xyz/js/src/motion.js?v=5.1.0"></script>

	<script type="text/javascript" src="js/src/affix.js-v=5.1.0"
		tppabs="http://Prince.xyz/js/src/affix.js?v=5.1.0"></script>

	<script type="text/javascript" src="js/src/schemes/pisces.js-v=5.1.0"
		tppabs="http://Prince.xyz/js/src/schemes/pisces.js?v=5.1.0"></script>

	<script type="text/javascript" src="js/src/bootstrap.js-v=5.1.0"
	...
	<script type="text/javascript">
		...
		var isfetched = false;
		// Search DB path;
		var search_path = "search.xml.htm"/*tpa=http://Prince.xyz/search.xml*/;
		if (search_path.length == 0) {
			search_path = "search.xml.htm"/*tpa=http://Prince.xyz/search.xml*/;
		}
	...
	<script src="../cdn1.lncld.net/static/js/av-core-mini-0.6.1.js"
